...
얼마 전 브랜드뉴스와 서면 인터뷰를 나눴다. 인터뷰이는 이 블로그의 주인장인 나, 닷커넥터 김진관이다. 1부에서는 AI 시대 교실의 변화와 교사의 역할, 그리고 '닷커넥터'라는 이름에 담긴 생각을, 2부에서는 교사 커뮤니티와 AITS 이야기를 나눴다. 그때의 답변을 원문 그대로 옮겨 기록으로 남겨 둔다. 원문 출처는 맨 아래에 있다.
...
프로필 — [소개 페이지](/about/) · [닷커넥터 링크트리](https://litt.ly/dot_connector)
