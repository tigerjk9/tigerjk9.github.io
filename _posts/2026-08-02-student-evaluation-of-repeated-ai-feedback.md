...
<figure>
<img src="/assets/student-evaluation-of-repeated-ai-feedback-fig-2.png" alt="AI 피드백 주요 지표의 전체 분포를 보여주는 6개 막대그래프">
<figcaption>그림 2. 주요 지표의 전체 분포. 왼쪽부터 AI 피드백에 대한 학생 정서(유용 57.1%·혼합 33.5%·비유용 9.4%), 평가 주제(실용적 지원 52.8% 등), 사용한 AI 도구(챗GPT 80.9%·제미나이 8.1%), AI 피드백 구체성(4점 대부분 구체적 91.3%·5점 매우 구체적 8.0%), 에세이 성찰 깊이(기술적 성찰 94.0%), Pangram 추정 저자(사람 59.8%·혼합 12.2%·AI 28.0%).</figcaption>
</figure>
...
- 구체적인 피드백은 학생들이 '일반적이거나 반복적이다'는 불만을 줄이는 데 기여함. 그림 4b를 보면 피드백 구체성이 1점에서 5점으로 높아질수록 학생이 '유용하다'고 평가할 확률은 약 44%에서 62%로 완만히 상승하고, '일반적·반복적'이라는 불만 확률은 약 14%에서 2%로 낮아짐. 또한 그림 4a는 성찰이 깊은 에세이일수록 조금 더 구체적인 피드백을 받았음을 보여줌.
- 다만 전체 피드백의 99%가 이미 상위 두 구간(4~5점)에 몰려 있어, 구체성 지표 하나만으로 피드백의 전반적 질이나 교육적 가치를 **단정할 수는 없음**.

<figure>
<img src="/assets/student-evaluation-of-repeated-ai-feedback-fig-4.png" alt="피드백 구체성과 성찰 깊이·유용성 평가의 관계를 보여주는 두 개의 점 추정 그래프">
<figcaption>그림 4. 구체성 관련 조정 추정치. A: 에세이 성찰 깊이가 깊어질수록(기술적→비판적) 피드백의 조정 구체성이 조금씩 상승함. B: 구체성이 높아질수록 '유용하다'는 평가 확률(초록)은 오르고 '일반적·반복적'이라는 불만 확률(주황)은 내려감. 막대는 95% 신뢰구간.</figcaption>
</figure>
...
<figure>
<img src="/assets/student-evaluation-of-repeated-ai-feedback-fig-3.png" alt="과제 회차(HW1~HW13)에 따른 반응 주제·유용성·성찰 깊이·채점 점수 변화를 보여주는 4단 그래프">
<figcaption>그림 3. 학기(HW1~HW13)에 따른 분포 변화. A: 학생 반응 주제 — 상단의 '실용적 지원'(초록)이 점차 줄고 오독·제약 불일치 등 비판적 반응이 늘어남. B: 피드백 유용성 평가(유용·혼합·비유용). C: 에세이 성찰 깊이. D: 교사 채점 점수(사각형 크기는 해당 점수 건수, 검은 선은 평균). 세로 점선은 HW4 이후 피드백 프롬프트가 개정된 시점.</figcaption>
</figure>
...
<figure>
<img src="/assets/student-evaluation-of-repeated-ai-feedback-fig-1.png" alt="에세이 임베딩을 UMAP으로 투영해 과제 회차·성찰 깊이·추정 저자별로 색칠한 세 개의 산점도">
<figcaption>그림 1. 데이터셋 개관. 각 점은 에세이 한 편으로, 문서 임베딩의 UMAP 투영 위에 배치됨(가까울수록 의미가 유사). A: 과제 회차(HW1~13)별로 뚜렷이 나뉘는 군집. B: 성찰 깊이 — 진한 점(대화적·비판적)은 소수이며 흩어져 있음. C: Pangram 추정 저자(사람·혼합·AI). B와 C를 겹쳐 보면 깊은 성찰로 분류된 영역과 AI 추정 텍스트(초록)가 상당 부분 겹침.</figcaption>
</figure>
