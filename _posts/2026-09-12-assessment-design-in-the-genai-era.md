...
(1) X1-X2-X3 패턴은 학생들의 학습 동기나 AI 도구에 대한 심리적 부담감에 어떤 영향을 미치며, 시간이 지남에 따라 AI 도구 사용 습관에 어떤 변화를 가져오는가?

(2) 이 평가 패턴을 AI 챗봇이 아닌 다른 유형의 AI (예: 이미지 생성 AI, 데이터 분석 AI, 코드 자동 완성 AI)를 활용하는 과제에 적용할 경우, X1-X2-X3의 각 요소는 어떻게 변형되어야 하는가?
