...
description: "교실에서 질문하는 사람을 교사에서 학생으로 바꾸자는 책. 질문형성기법(QFT)의 구조와, AI가 답을 값싸게 내놓는 시대에 이 20년 된 방법이 왜 다시 절실해지는지, 그리고 데이터의 빈틈까지 함께 읽는다."
permalink: /post/rothstein-make-just-one-change/
---
교실에서 질문은 대개 교사가 한다. 교사가 묻고 학생이 답한다. 댄 로스스타인과 루스 산타나는 이 오래된 배치에서 딱 하나만 바꾸자고 말한다. 질문하는 사람을 학생으로 바꾸는 것. 책 제목 『한 가지만 바꾸기』가 가리키는 그 한 가지다.

주장은 단순하지만 세다. 자기 질문을 만드는 것이 학습에서 가장 본질적인 단일 기술이라는 것이다. 그리고 이 기술은 타고나는 게 아니라 가르칠 수 있다고 말한다.

## 질문을 만드는 기술, QFT

두 사람이 20여 년에 걸쳐 다듬은 방법이 질문형성기법(QFT)이다. 절차는 여섯 단계로 짜여 있다.
...
그럼에도 이 책이 겨눈 과녁은 시간이 갈수록 또렷해진다. 교사의 역할이 답을 가르치는 사람에서 질문을 설계하는 사람으로 옮겨간다는 것. AI가 답을 도맡는 시대에 이보다 정확한 역할 재정의는 드물다. 한 가지만 바꾸라는 제안은 작아 보이지만, 그 한 가지가 나머지를 바꾼다.
