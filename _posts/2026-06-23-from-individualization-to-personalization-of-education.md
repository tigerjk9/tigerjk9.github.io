...
-   **Chen, Y. (2025) 연구 (의대생)**: AI 플랫폼을 사용한 의대생 그룹은 대조군 대비 **학업 성취도 평균 84.47점 vs 81.72점**으로 유의미하게 높았다. 또한 **하루 자율 학습 시간은 49.25분에서 34.80분**으로 증가했고, 과학 문헌 독서량은 1.5배 늘어났다. 이는 AI가 학업 성취도, 학습 만족도, 자기 주도 학습 능력을 동시에 높일 수 있음을 보여준다.

<figure>
<img src="/assets/from-individualization-to-personalization-of-education-fig-1.png" alt="해외 AI 기반 개인화 학습 시스템 사례">
<figcaption>그림 1. 해외 주요 AI 학습 시스템 — Squirrel AI, Knewton, Carnegie Learning, 의대생 실험 등 6개 사례.</figcaption>
</figure>
...
<figcaption>그림 2. 러시아 주요 AI 학습 시스템 — 스베르클래스, 인스쿨테크, 디지털 미러, ITMO 생태계 등 6개 사례.</figcaption>
</figure>
