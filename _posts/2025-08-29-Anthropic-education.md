...
보고서에 따르면, 교육자들은 재무 관리나 기록 보관 같은 단순 행정 업무는 **'자동화'**하는 반면, 수업 설계나 학생 상담처럼 창의성과 인간적인 교감이 필요한 영역에서는 AI를 **'협업'** 도구로 사용합니다. 모든 것을 AI에 맡기기보다는, 어떤 업무를 위임하고 어떤 부분에 더 집중할지 전략적으로 판단하는 것이 중요합니다.
...
@online{benthand2025education,
 ...
 date = {2025-08-26},
 year = {2025},
 url = {[https://www.anthropic.com/news/anthropic-education-report-how-educators-use-claude](https://www.anthropic.com/news/anthropic-education-report-how-educators-use-claude)},
}
