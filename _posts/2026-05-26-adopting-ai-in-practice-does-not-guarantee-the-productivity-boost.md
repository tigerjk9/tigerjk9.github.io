...
(1) AI 도입이 생산성 향상을 보장하지 않는다는 입장을 명확히 함. 기존 Gries & Naude´ (2022)의 부분 균형 모델을 비판적으로 검토함. 이 모델은 AI 역량을 외생적 기술 변수로 취급하나, 본 연구는 AI 역량이 현장 생산성으로 전환되는 과정에 개입하는 인간 및 환경 요인을 내생적 변수로 정의함.
...
| 요인명              | 설명                                                         | 주요 역할                                                                                                                                                                                                                                                                                                                                                                            | Gries-Naude´ 모델 수정                                                                                                                                                                                                                                                                                                                                                                                                               |
| :------------------ | :----------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
이러한 다섯 가지 요인은 Gries-Naude´ 모델의 핵심 매개변수들을 다음과 같이 수정함.
