...
손흥민 선수의 존재는 감독에게도 매우 중요한 전술적 자원이다. 그는 뒷공간으로 침투하는 능력과 함께, 아래로 내려와 볼을 받아 연결하는 능력 모두를 지닌다. 이처럼 종적인 움직임이 모두 가능하다는 점은 전술 운용에 있어 매우 중요한 도구가 된다.
...
이 글은 오현규 선수를 향한 애정을 전제로 하며, 두 선수가 함께 뛰며 시너지를 내는 것을 가장 이상적인 결과로 본다. 다가오는 멕시코전에서 선수들이 최선을 다해 좋은 결과를 만들기를 응원한다.
