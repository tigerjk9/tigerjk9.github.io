...
인공지능(AI)이 급부상하면서 ‘일을 잘한다’는 개념이 앞으로 어떻게 변할지 많은 이가 궁금해한다. 얼마 전 유명 테크 기업의 사내 인터뷰에서 나 역시 같은 질문을 받았다. ‘AI 시대, 일을 잘한다는 것이 완전히 달라지지 않을까요?’ 나의 대답은 이렇다. 일 잘함의 본질은 바뀌지 않지만, 각 역량의 무게중심은 크게 달라진다.
