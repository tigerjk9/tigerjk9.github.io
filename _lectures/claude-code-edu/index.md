...
원작 황민호 자료를 **교육자 현장 어휘**로 다시 적은 닷커넥터(김진관) 큐레이션 버전.

- **[슬라이드 보기 (Reveal.js)](/assets/lectures/claude-code-edu/slides.html){:target="_blank"}** — 96장 · 표지·강사 소개·마무리에 원작자/큐레이터 병기, 22개 기능은 원본 구조 유지
- **[핸드아웃 (A4 HTML)](/assets/lectures/claude-code-edu/handout.html){:target="_blank"}** — 7면 · "개발팀"을 "동료 교육자"로 환원, 체크리스트·시나리오·보안 한 컷까지 재편집
