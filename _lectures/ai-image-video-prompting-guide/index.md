...
이 가이드의 진짜 쓸모는 읽고 끝내는 데 있지 않다. 원리를 한 번 숙지한 다음, 자주 쓰는 지시사항을 제미나이 젬이나 GPTs로 만들어 두고 필요할 때 불러 쓰는 것이 핵심이다. 매번 프롬프트를 처음부터 짜는 대신, 우리 단체의 톤과 규칙을 미리 담은 도구를 만들어 두는 셈이다.
...
| 항목 | 내용 |
|------|------|
| 원작 | The Prompting Handbook (v1.2, 2026-07, Magnific Studios) |
| 구성 | 이미지 프롬프팅 · 비디오 프롬프팅 · 샷 디렉팅 · 치트시트 |
| 대상 | 단체·활동가·콘텐츠 제작자 (이미지·영상 생성 AI 이용자) |
| 동반 자료 | 김용성 『챗GPT 이미지 만들기 1600제』 (2026) |
| 큐레이션 | 김진관 (닷커넥터) |

## 출처

- 원작 개념·표 — The Prompting Handbook (v1.2, 2026-07) · Magnific Studios ([magnific.com](https://magnific.com){:target="_blank"})
- 동반 자료 — 김용성 『챗GPT 이미지 만들기 1600제』 (2026), 400개 실전 프롬프트와 1,600개 실전 이미지로 원리를 반복 훈련하는 짝 자료
- 큐레이션 — 김진관 (닷커넥터)
